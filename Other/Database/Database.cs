...
namespace LoginServer
{
    public static class DB
    {
        ...
        /// <summary> 
        /// Cierra la conexión con los datos de MySQL, se ignoran los errores. 
        /// </summary> 
        public static void closeConnection()
        {
            Log.WriteLine("Cerrando la conexion con la DB...");
            try
            {
                dbConnection.Close();
                Log.WriteLine("Conexion con la DB cerrada.");
            }
            catch { Log.WriteError("Sin conexion con la DB."); }
        }
        #endregion

        #region Database data manipulation
        /// <summary> 
        /// Ejecuta una instrucción SQL en la DB 
        /// </summary> 
        /// <param name="Query">Sentencia SQL a ejecutar. Sintaxis SQL por defecto.</param> 		
        ...
        #region runRead
        /// <summary> 
        /// Realiza una consulta SQL y devuelve el primer campo seleccionado como cadena. Otros campos son ignorados. 
        /// </summary> 
        /// <param name="Query">La consulta SQL que selecciona un campo.</param> 
        ...
        /// <summary> 
        /// Intenta encontrar coincidencias con la consulta de los campos. Cuando hay al menos un resultado, devuelve True y se para. 
        /// </summary> 
        /// <param name="Query">La consulta SQL que contiene las condiciones y campos concretos. Se añade LIMIT 1.param> 
