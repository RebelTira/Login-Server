...
public class LookupService
{
  ...
  "Saint Barthelemy","Saint Martin", "Bonaire, Saint Eustatius and Saba"};
    ...
    public LookupService(String databaseFile, int options)
    {
        ...
        {
            Log.WriteError("cannot open file " + databaseFile + "\n");
        }
    }
    ...
    public Location getLocationV6(IPAddress addr)
    {
        ...
        {
            Log.WriteError("IO Exception while seting up segments");
        }
        return record;
    }
    [MethodImpl(MethodImplOptions.Synchronized)]
    ...
    private int SeekCountryV6(IPAddress ipAddress)
    {
        ...
        Log.WriteError("Error Seeking country while Seeking " + ipAddress);
        return 0;
